...
Masivo web
Los usuarios con privilegios podran enviar desde una pagina web mensajes masivos a todos lo telefonos de la red de El Salvador, por sexo, edades y zona geografica (previamente deberán enviar especificaciones por sms o web).
Masivo movil
...
Gracias a las ventajas del software libre se logro desarrollar esta solucion basada en las necesidades de las mujeres organizadas y el codigo fuente de una herramienta similar se logro construir un medio de comunicación alternativo que comunique a nuestras defensoras de derechos humanos\t\t\t\t\t\t\t</p>
 ";
          ...
          <p>
           Esta Funcion se activa enviando la palabra estatus, la herramienta envía un mensaje con el nombre que se registro y cuando se registro y su rol en la herramienta.
           <b>Ejemplo:         estatus</b>
           </p>
          <h2>Funcion DATO</h2>
          <p>
          ...
          <h2>Funcion AYUDA</h2>
          <p>
           recibirás informacion sobre las diferentes instancias a las que puedes acudir, segun el lugar donde te encuentres o puedes enviar esta informacion a otro telefono agregando el numero al final.
           <b>Ejemplo:         ayuda</b>
          ...
          <p>
           ...
           <b>Ejemplos:<br>
             ...
             <li>invitar 70947743 regístrate karla a la red de comunicacion digital, nos ayudara a todas a denunciar el maltrato</li>
            </b></ul><b>
           </b>
          <p></p>
          <h2>Funcion: SALIR</h2>
...
\t\t\t\t\t\t\t<p>En el Salvador gran parte de la ciudadani­a posee acceso a telefonia movil, datos consultados en la Superintendencia General de Electricidad y Telecomunicaciones SIGET revelan que el uso de telefonia celular supera en gran proporcion a la telefonia fija. Los registros informan que a mediados del anyo 2012 habi­an 8,485,684 lineas móviles en operacion y que la densidad movil para el anyo 2011 era de 134.50, es decir que por cada 100 habitantes se tendran 134 lineas moviles.
