...
class ScdDenuncia
{
    ...
    /**
     * @var string $remitentedenuncia
     */
    private $remitentedenuncia;
    ...
    /**
     * Set remitentedenuncia
     *
     * @param string $remitentedenuncia
     */
    public function setRemitentedenuncia($remitentedenuncia)
    {
        $this->remitentedenuncia = $remitentedenuncia;
    }

    /**
     * Get remitentedenuncia
     *
     * @return string 
     */
    public function getRemitentedenuncia()
    {
        return $this->remitentedenuncia;
    }
